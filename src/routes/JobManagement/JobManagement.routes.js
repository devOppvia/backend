...
router.put("/resume-job/:jobId", jobManagementControllers.resumeJob)
...
router.post("/generate-screening-questions", jobManagementControllers.generateScreeningQuestions)
router.post("/generate-additional-benefits", jobManagementControllers.generateAdditionalBenefits)
