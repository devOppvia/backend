    ...
    const plans = [
      {
        ...
        interviewCredits: 2,
        duration: 30,
        interviewMode: ["COMPANY", "PRACTICE"],
        interviewDuration: ["MIN_3", "MIN_15", "MIN_30"],
        interviewType: 3,
        identityVerification: ["ENABLE", "DISABLE"],
      ...
      },
      {
        ...
        duration: 60,
        interviewMode: ["COMPANY", "PRACTICE"],
        interviewDuration: ["MIN_3", "MIN_15", "MIN_30", "MIN_45", "MIN_60"],
        interviewType: 9,
        identityVerification: ["ENABLE", "DISABLE"],
